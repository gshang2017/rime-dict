...
def merge_file(file_1, file_2):
    f1 = open(file_1,'a+',encoding='utf-8')
...
'''
    ...
    #if os.path.exists(filename_1+".dict.yaml"):
        #if os.path.exists(filename_1+".txt"):
            #os.remove(filename_1+".txt")
        #if os.path.exists('polyphonic_dict.txt'):
            #os.remove('polyphonic_dict.txt')
